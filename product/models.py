...
class Product(models.Model):
    ...
    gender_code    = models.OneToOneField('GenderCode', on_delete=models.CASCADE)
    age_level      = models.OneToOneField('AgeLevel', on_delete=models.CASCADE)
    activity_level = models.OneToOneField('ActivityLevel', on_delete=models.CASCADE)
